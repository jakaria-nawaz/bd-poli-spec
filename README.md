...
bam-dan-analytics/
│
├── METHODOLOGY.md                  # Scoring logic, weights, label thresholds, known limitations
...
See [METHODOLOGY.md](METHODOLOGY.md) for the full methodology reference — scoring logic, question weights, normalization, label thresholds, and known limitations (including the Centrist classification trade-off).
